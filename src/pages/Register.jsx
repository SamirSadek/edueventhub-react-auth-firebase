      ...
      <div>
        <div className="hero p-10 ">
          <div className="hero-content w-full flex-col">
            ...
            <h1 className="text-2xl font-bold bg-white text-Black  px-32 py-2 rounded shadow-2xl border-t-8 border-black">Signup now</h1>
            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
              <form onSubmit={handleSignUp} className="card-body">
                ...
                <button className="btn btn-primary bg-black text-white w-full">Signup</button>
                </div>
              </form>
              <p className="text-center mb-3 font-thin">Already Have an Account?? <Link className="text-red-500 underline" to="/login">Login</Link></p>
